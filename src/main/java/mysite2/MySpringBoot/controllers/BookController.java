...
public class BookController {
    ...
    @Tag(name="Вывод инфы по конкретной книге + показывает кто взял эту книгу с возможность удалить владельца + если книга ничья, то выводится список всех людей и возможность забронировать книгу")
    @GetMapping("/{id}")
    ...
    @Tag(name="Вывод формы, добавляющую новую книгу")
    @GetMapping("/new")
    public void newBook(@ModelAttribute("book") Book book){
        //return new Book();
    }

    @Tag(name="Добавление новой книги")
    @PostMapping()
    ...
    @Tag(name="Вывод формы, редактирующую выбранную книгу")
    @GetMapping("/{id}/edit")
    ...
    @Tag(name="Обновление данных выбранной книги")
    @PatchMapping("/{id}")
    ...
    @Tag(name="Удаление выбранной книги")
    @DeleteMapping("/{id}")
    ...
    @Tag(name="Удаление владельца выбранной книги")
    ...
    @Tag(name="Установка владельца выбранной книги")
    ...
    @Tag(name="Вывод формы поиска книг по названию с возможностью пагинации и сортировки по году (параметры page, books_per_page, sortbyyear)")
    @GetMapping("/search")
    public void searchPage() {
        //return "books/search";
    }

    @Tag(name="Вывод результатов поиска с учетом пагинации и сортировки по году выпуска книги")
    @PostMapping("/search")
